	...
	return (
		<figure
			className={cx(className, styles.base, {
				[styles["base--drawing"]]: drawingStarted,
			})}
			{...props}
		>
...
export const MacOutline = React.forwardRef<SVGSVGElement, SVGProps>(
	({ className, ...props }, ref) => {
		return (
			<SVG
				className={cx(styles.outline, className)}
